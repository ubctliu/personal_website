const Personal = () => {
  return (
    <section>
      <div className={"mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl dark:text-white"}>Hello, I&apos;m Terrence Liu!</div>
